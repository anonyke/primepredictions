...
const styles = {
  ...
  heroBg: {
    ...
    right: 0,
    bottom: 0,
    background: 'radial-gradient(ellipse 80% 60% at 50% -20%, rgba(0,229,255,0.12) 0%, transparent 60%), radial-gradient(ellipse 60% 50% at 80% 80%, rgba(124,77,255,0.1) 0%, transparent 50%), radial-gradient(ellipse 50% 40% at 20% 80%, rgba(255,215,0,0.06) 0%, transparent 50%)',
    zIndex: 0,
  },
  heroGrid: {
    position: 'absolute',
        ...
        <section style={styles.hero}>
          ...
          <div style={styles.heroContent}>
            ...
            <div style={styles.statsBar}>
              ...
              <div style={styles.statItem}>
                <div style={{ ...styles.statValue, color: '#00E676' }}>87%</div>
                <div style={styles.statLabel}>Win Rate</div>
              </div>
              <div style={styles.statItem}>
                <div style={styles.statValue}>15,000+</div>
                <div style={styles.statLabel}>Predictions</div>
              </div>
              <div style={styles.statItem}>
                <div style={{ ...styles.statValue, color: '#FFD700' }}>4.9★</div>
            ...
            <table style={styles.table}>
              ...
              <tbody>
                {filteredPredictions.map((p) => (
                  <tr key={p.id} style={{ transition: 'background 0.3s ease', cursor: 'pointer' }}
